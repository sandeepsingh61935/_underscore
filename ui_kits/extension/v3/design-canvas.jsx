...
if (typeof document !== 'undefined' && !document.getElementById('dc-styles')) {
  ...
  s.textContent = [
    ...
    '[data-dc-slot].dc-dragging .dc-card{box-shadow:0 12px 40px var(--utility-overlay-25),0 0 0 2px var(--accent);transform:none}',
...
function DCFocusOverlay({ entry, sectionMeta, sectionOrder }) {
  ...
  return ReactDOM.createPortal(
    <div onClick={() => ctx.setFocus(null)}
      ...
      style={{ position: 'fixed', inset: 0, zIndex: 100, background: 'var(--dc-backdrop)', backdropFilter: 'none',
