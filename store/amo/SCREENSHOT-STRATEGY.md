...
**Brand:** Editorial V2/V3 — paper `#F7F5F0`, ink `#111110`, single terracotta accent  
...
Avoid: AI hype, cluttered browser chrome, fake social proof, feature laundry lists.
...
- **Type:** Instrument Serif / Source Serif for titles; DM Sans / Inter for body; mono for kickers  
- **Accent:** use sparingly (underline mark, CTAs, highlight chip)—not rainbow UI  
