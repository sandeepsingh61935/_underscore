...
- [ ] **No Code Smells**: No `import logging`, no bare
      [except](file:///home/sandy/projects/healthio/backend/tests/unit/foundation/test_logging.py#64-86)
...
**File**:
[.pre-commit-config.yaml](file:///home/sandy/projects/healthio/.pre-commit-config.yaml)
...
This testing strategy is **mandatory** for all future domain migrations. Any PR
that doesn't include all 4 test layers will be rejected in code review.
