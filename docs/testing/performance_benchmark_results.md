...
**Updated to 100ms** for CI reliability and consistent test results across
environments.

**Rationale**: Provides 30x headroom over actual performance (3ms), ensuring
tests remain stable under varying system loads.
