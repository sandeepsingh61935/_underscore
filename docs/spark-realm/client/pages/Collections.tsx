          ...
          <div className="inline-flex h-12 items-center justify-center rounded-full bg-secondary/50 p-1">
            {['vault', 'xai'].map((m) => (
              <button
                ...
                className={`relative flex cursor-pointer items-center justify-center px-6 h-full rounded-full transition-all duration-300 ${
                  mode === m
          ...
          <div className="inline-flex h-10 items-center justify-center rounded-full bg-secondary/50 p-1">
            {(['alphabetical', 'usage', 'recent'] as const).map((sort) => (
              <button
                ...
                className={`relative flex cursor-pointer items-center justify-center px-4 h-full rounded-full transition-all duration-300 text-sm font-medium tracking-wide ${
                  sortBy === sort
                    ? 'bg-card text-primary shadow-sm'
                    : 'text-muted-foreground hover:text-foreground'
                }`}
