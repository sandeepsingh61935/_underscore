 ...
 */
export function createMockHighlight(overrides?: Partial<HighlightDataV2>): HighlightDataV2 {
    return {
        version: 2,
 ...
 */
export function createMockHighlightRecord(id: string, url: string = 'https://example.com') {
    return {
        id,
        url,
