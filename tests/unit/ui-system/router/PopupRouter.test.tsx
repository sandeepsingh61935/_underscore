...
import { PopupRouter, useRouter, useNavigate, useParams, Route, Switch } from '@/ui-system/router/PopupRouter';
...
function RouterProbe() {
    ...
    return (
        <div>
            ...
            <button data-testid="go-signin" onClick={() => navigate('sign-in', { domain: 'x.com' })}>signin</button>
            <button data-testid="go-collections" onClick={() => navigate('collections')}>collections</button>
...
describe('PopupRouter', () => {
    ...
    it('Route renders children only when its path matches', () => {
        render(
            <PopupRouter initialRoute="welcome">
                <Route path="welcome"><span data-testid="welcome">welcome content</span></Route>
                <Route path="sign-in"><span data-testid="signin">signin content</span></Route>
            </PopupRouter>
        );
    ...
    it('Switch renders only the first matching child', () => {
        render(
            <PopupRouter initialRoute="welcome">
                <Switch>
                    <Route path="welcome"><span data-testid="first">a</span></Route>
                    <Route path="welcome"><span data-testid="second">b</span></Route>
                </Switch>
            </PopupRouter>
        );
