...
describe('WalkMode - Ephemeral Highlighting', () => {
    ...
    describe('Highlight Creation', () => {
        ...
        it('should reject empty selection', async () => {
            ...
            // Act & Assert
            await expect(walkMode.createHighlight(emptySelection, 'yellow'))
    ...
    describe('Highlight Removal', () => {
        ...
        it('should handle removal of non-existent highlight gracefully', async () => {
            ...
            await expect(walkMode.removeHighlight('non-existent-id'))
    ...
    describe('Edge Cases', () => {
        it('should handle multiple highlights with different colors', async () => {
            // Arrange & Act
            const id1 = await walkMode.createHighlight(createMockSelection('Yellow text'), 'yellow');
            const id2 = await walkMode.createHighlight(createMockSelection('Blue text'), 'blue');
            const id3 = await walkMode.createHighlight(createMockSelection('Green text'), 'green');
