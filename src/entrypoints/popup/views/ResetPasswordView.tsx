 ...
 */
export function ResetPasswordView({ email, onSuccess, onBack }: ResetPasswordViewProps): React.ReactElement {
    ...
    return (
        <AuthScreenShell
            ...
            subtitle={<>We sent a 6-digit code to <span style={{ fontWeight: 500, color: 'var(--ink)' }}>{email}</span></>}
            error={error}
            footer={
                <>
                    <p
        ...
        >
            ...
            <form onSubmit={(e) => void handleSubmit(e)} style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                    <label htmlFor="popup-reset-password" className="u-kicker" style={{ color: 'var(--ink-3)' }}>
                        New password
                    </label>
                    <Input
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                    <label htmlFor="popup-reset-confirm" className="u-kicker" style={{ color: 'var(--ink-3)' }}>
                        Confirm password
                    </label>
                    <Input
