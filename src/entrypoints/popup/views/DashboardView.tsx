...
export function DashboardView({ onLogout }: DashboardViewProps) {
    ...
    return (
        <div className="w-[360px] h-[600px] flex flex-col bg-bg-base-light dark:bg-bg-base-dark">
            {/* Header */}
            <header className="flex items-center justify-between px-4 py-3 border-b border-border-light dark:border-border-dark bg-bg-surface-light/80 dark:bg-bg-surface-dark/80 backdrop-blur-md sticky top-0 z-10">
