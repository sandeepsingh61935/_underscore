...
import type { IEventStore, SyncEvent, EventFilter } from './interfaces/i-event-store';
...
export class EventStore implements IEventStore {
   ...
   */
  private createTimestampRange(since?: number, until?: number): IDBKeyRange | undefined {
