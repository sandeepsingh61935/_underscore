  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-surface text-on-surface">
      ...
      <article className="w-full max-w-[640px] px-6 pb-12">
        <Link
          to="/"
          className="inline-flex items-center gap-1.5 text-body-small no-underline mb-5 text-outline transition-colors duration-short ease-standard hover:text-primary"
        >
          ← Back
        </Link>
