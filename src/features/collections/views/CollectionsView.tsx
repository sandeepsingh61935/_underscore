        ...
        >
            ...
            >
                ...
                <button
                    ...
                    className="inline-flex h-12 w-12 items-center justify-center rounded-full transition-all duration-short ease-standard hover:-translate-y-0.5 bg-surface-container-lowest border border-outline-variant shadow-elevation-1 text-outline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
                >
                    <Settings size={17} />
                </button>
            </header>
            ...
            <div className="w-full max-w-[640px] px-6 pb-6 flex-1 flex flex-col min-h-min">
                ...
                {/* Search */}
                <div
                    className="flex items-center gap-[10px] px-4 py-3 rounded-md mb-6 transition-all duration-short ease-standard bg-surface-container-lowest border border-outline-variant focus-within:border-outline focus-within:shadow-elevation-1"
                >
