...
} from './simple-highlight-commands';
...
export class CommandFactory {
  ...
  createCreateHighlightCommand(
    ...
    return new CreateHighlightCommand(selection, colorRole, modeManager, logger);
  }
  ...
  createRemoveHighlightCommand(highlightId: string): RemoveHighlightCommand {
    ...
    return new RemoveHighlightCommand(highlightId, modeManager, logger);
  }
}
