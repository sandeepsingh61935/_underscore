...
export const TRANSITION_MATRIX: Record<ModeType, Record<ModeType, TransitionRule>> = {
    walk: {
        ...
        vault: {
            ...
            reason: 'Switching to Vault mode will permanently archive highlights. This action persists data.',
            guard: async () => {
    ...
    sprint: {
        walk: {
            ...
            allowed: true,
            requiresConfirmation: true,
            reason: 'Switching to Walk mode will stop persisting new highlights. Existing highlights will remain.',
            guard: async () => {
        ...
        vault: {
            ...
            allowed: true,
            requiresConfirmation: true,
            reason: 'Switching to Vault mode will archive all highlights permanently. Data will persist.',
            guard: async () => {
    ...
    vault: {
        walk: {
            ...
            allowed: true,
            requiresConfirmation: true,
            reason: 'Switching to Walk mode may result in highlight data being lost if not saved',
            guard: async () => {
