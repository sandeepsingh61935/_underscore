 ...
 *
 * Auth-only storage sync. Paid (pro_xai) is projected by BillingProvider when
 * entitlement load is ready — this hook does not know about Polar.
 */
