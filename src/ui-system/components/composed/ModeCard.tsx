  ...
  return (
    <button
      ...
      className={cn(
        ...
        // Locked State
        isLocked &&
          'opacity-50 cursor-not-allowed hover:border-outline hover:bg-transparent hover:shadow-none bg-surface-container-lowest',
    ...
    >
      <div className="flex items-start justify-between w-full mb-2">
        ...
        <div className="flex items-center gap-3">
            ...
            <div
              className={cn(
                ...
                isActive
                  ...
                  : 'bg-surface-container-high text-on-surface-variant group-hover:text-primary group-hover:bg-primary/5'
              )}
            >
              {icon}
            </div>
          ...
          <div>
            <h3
              className={cn(
                'text-title-medium tracking-tight transition-colors',
                isActive
                  ? 'text-on-primary'
      ...
      {description && (
        <p
          className={cn(
            'text-body-small leading-relaxed pl-[calc(2.5rem+0.75rem)]', // Align with text start (icon width + gap)
