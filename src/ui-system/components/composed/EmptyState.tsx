        ...
        <div className="flex items-center gap-3 mt-6">
          {action && (
            <button
              ...
              className="inline-flex min-h-[48px] items-center justify-center px-4 py-2 bg-primary text-primary-foreground text-label-large rounded-lg hover:bg-primary/90 transition-colors focus:outline-none focus:ring-2 focus:ring-primary/50"
            >
              {action.label}
            </button>
          )}
          {secondaryAction && (
            <button
              ...
              className="inline-flex min-h-[48px] items-center justify-center px-4 py-2 bg-secondary text-secondary-foreground text-label-large rounded-lg hover:bg-secondary/80 transition-colors focus:outline-none focus:ring-2 focus:ring-secondary/50"
            >
