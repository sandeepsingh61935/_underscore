    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2">
          <h3 className="text-title-small text-foreground truncate group-hover:text-primary transition-colors">
            {domain}
          </h3>
          {category && (
            <span className="shrink-0 px-2 py-0.5 text-label-medium text-muted-foreground bg-secondary rounded-full">
              {category}
            </span>
          )}
        </div>
        <p className="text-label-small text-muted-foreground mt-0.5">
      ...
      <div
        className="shrink-0 w-8 h-8 rounded-full flex items-center justify-center bg-secondary/50 group-hover:bg-primary/10 transition-colors"
        aria-hidden="true"
      >
