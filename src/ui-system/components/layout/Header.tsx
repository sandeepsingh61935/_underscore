                ...
                <div className="flex items-center gap-6">
                    ...
                    {isAuthenticated && (
                        <button
                            ...
                            className="hidden sm:inline-flex min-h-[48px] items-center rounded-md px-3 text-sm font-medium text-muted-foreground transition-colors duration-short ease-standard hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
                        >
                            Dashboard
                        </button>
                    )}
                                                ...
                                                <DropdownMenuSubContent>
                                                    {themes.map((t) => (
                                                        <DropdownMenuItem
                                                            ...
                                                            className={`flex items-center gap-2 cursor-pointer ${theme === t.id ? 'text-primary' : ''
                                                                }`}
                                                        >
                                                            {t.icon}
                                                            <span>{t.label}</span>
