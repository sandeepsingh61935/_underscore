-- Grounded chat persistence (ADR-028).
-- Source of truth for signed-in Chat history. No secrets on rows.
...
CREATE INDEX chat_threads_user_updated_at_idx
...
-- RLS: owner-only; FORCE so table owners cannot bypass.
